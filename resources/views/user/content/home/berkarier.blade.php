                ...
                <div class="col-lg-9 column">
                    <div class="blog-single">
                        ...
                        <div class="tags-share">
                            ...
                            <div class="share-bar">
                                <a href="#" title="" class="share-fb"><i class="fa fa-facebook"></i></a><a href="#"
                                    title="" class="share-twitter"><i class="fa fa-twitter"></i></a><a href="#" title=""
                                    class="share-google"><i class="la la-google"></i></a><span>Share</span>
                            </div>
                        </div>
                        <div class="post-navigation ">
                            <div class="post-hist prev">
                                <a href="#" title=""><i class="la la-arrow-left"></i><span class="post-histext">Prev
                                        Post<i>Hey Job Seeker, It’s Time</i></span></a>
                            </div>
                            <div class="post-hist next">
                                <a href="#" title=""><span class="post-histext">Next Post<i>11 Tips to Help You Get
                                            New</i></span><i class="la la-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="comment-sec">
                            ...
                            <ul>
                                <li>
                                    <div class="comment">
                                        <div class="comment-avatar"> <img src="http://placehold.it/90x90" alt="" />
                                        </div>
                                        <div class="comment-detail">
                                            <h3>Ali TUFAN</h3>
                                            <div class="date-comment"><a href="#" title=""><i
                                                        class="la la-calendar-o"></i>Jan 16, 2016 07:48 am</a></div>
                                    ...
                                    <ul class="comment-child">
                                        <li>
                                            <div class="comment">
                                                <div class="comment-avatar"> <img src="http://placehold.it/90x90"
                                                        alt="" /> </div>
                                                <div class="comment-detail">
                                                    <h3>Rachel LOIS</h3>
                                                    <div class="date-comment"><a href="#" title=""><i
                                                                class="la la-calendar-o"></i>Jan 16, 2016 07:48 am</a>
                                                    </div>
                                                    <p>Far much that one rank beheld bluebird after outside ignobly
                ...
                <aside class="col-lg-3 column">
                    ...
                    <div class="widget">
                        ...
                        <div class="photo-widget">
                            <div class="row">
                                <div class="col-lg-4 col-md-2 col-sm-2 col-xs-6"> <a href="#" title=""><img
                                            src="http://placehold.it/79x57" alt="" /></a> </div>
                                <div class="col-lg-4 col-md-2 col-sm-2 col-xs-6"> <a href="#" title=""><img
                                            src="http://placehold.it/79x57" alt="" /></a> </div>
                                <div class="col-lg-4 col-md-2 col-sm-2 col-xs-6"> <a href="#" title=""><img
                                            src="http://placehold.it/79x57" alt="" /></a> </div>
