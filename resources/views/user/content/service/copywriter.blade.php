                ...
                <div class="col-lg-8 column">
                    <div class="job-single-sec">
                        <div class="job-single-head">
                            <div class="job-thumb"> <img src="{{ asset ('user/images/cw2.jpeg')}}" alt="" /> </div>
                        </div><!-- Job Head -->
                        <div class="job-details">
                            <h3>Deskripsi</h3>
                            <p align="justify">Copywriter merupakan salah satu profesi yang saat ini menjamur di dunia
                                kerja, karena kebutuhannya yang semakin meningkat di kalangan perusahaan. Bisa dibilang
                                copywriter merupakan ujung tombak sebuah konten marketing. Tidak hanya membuat konten
                                biasa, seorang copywriter juga harus bisa ‘bermain’ dengan kata-kata persuasif yang bisa
                                memengaruhi minat beli konsumen. Profesi yang satu ini juga bisa dijalani dengan sistem
                                kerja full time, part time, remote, hingga freelance. Prospek karier untuk profesi ini
                                tentu sangat cerah, apalagi seorang copywriter terkadang tidak harus terikat satu
                                perusahaan saja, sehingga kesempatan untuk mendapatkan penghasilan yang lebih banyak
                                akan terbuka lebar. Seorang copywriter harus memiliki beberapa kemampuan agar siap
                                bersaing di industri. Di Jobhun Academy, kamu bisa belajar menjadi seorang copywriter
                                bersama dengan pakarnya langsung dari media ternama. Tidak hanya belajar secara teori
                                saja, namun kamu juga akan praktek, sehingga bisa menghasilkan portfolio tulisan yang
                                akan digunakan untuk mencari kerjaan nantinya. Selain itu, kamu juga bisa mempersiapkan
                                karier sebagai seorang copywriter melalui program ini.
                            </p>

                            <h3>Mengapa kamu harus mengikuti Jobhun Academy : Copywriter ini ?</h3>
                            <p>
                            ...
                            <p>
                                ...
                                11. Persiapan karier: Tips mendapatkan pekerjaan di bidang copywriting, baik freelance
                                maupun full time. <br>
                                12. Persiapan karier: Tips membuat CV dan portfolio yang menarik bagi copywriter <br>
                                13. Persiapan karier: Tips menjadi copywriter yang produktif dan tidak mudah terkena
                                writer’s block
                            </p>
                        </div>
                        <div class="share-bar">
                    ...
                    <div class="job-location">
                        ...
                        <div class="col-lg-12 column">
                            <div class="blog-single">
                                <div class="bs-thumb">
                                    <img src="{{ asset ('user/images/mentorcopywriter.jpg')}}"
                                        alt="Gambar Mentor Content Writer" />
                                    <div class="extra-job-info">
                                        <span><strong>Fazrah LR Heryanda</strong> <br>( Freelance copywriter & Editor of Basha.ID )</span>
                                    </div>
                                    <div class="col-lg-4 column">
