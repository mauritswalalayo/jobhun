			...
			<div class="row">
				<div class="col-lg-8 column">
					<div class="job-single-sec">
						...
						<div class="job-details">
							...
							<ul>
								...
								<li>Proficient in Photoshop, Illustrator, bonus points for familiarity with Sketch
									(Sketch is our preferred concepting)</li>
						...
						<div class="share-bar">
							<span>Share</span><a href="#" title="" class="share-fb"><i class="fa fa-facebook"></i></a><a
								href="#" title="" class="share-twitter"><i class="fa fa-twitter"></i></a>
						</div>
								...
								<div class="job-listings-sec no-border">
									<div class="job-listing wtabs">
										<div class="job-title-sec">
											...
											<div class="job-lctn"><i class="la la-map-marker"></i>Sacramento, California
											</div>
										</div>
