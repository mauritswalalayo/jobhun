				...
				<div class="col-lg-8 column">
					<div class="job-single-sec">
						...
						<div class="job-details">
							<h3>Deskripsi</h3>
							<p align="justify">Tidak berbeda jauh dengan web developer, Android developer juga menjadi
								salah satu profesi yang banyak dicari. Menjamurnya digital startup di kalangan pebisnis
								membuat banyak perusahaan ingin turut serta mendigitalisasi bisnisnya. Banyak perusahaan
								berlomba-lomba ingin menciptakan sebuah produk melalui aplikasi Android. Di sini, peran
								seorang Android developer sangat besar dalam membangun produk sebuah perusahaan. Tidak
								hanya perusahaan saja yang membutuhkan profesi ini, namun seorang Android Developer juga
								bisa bekerja secara mandiri. Profesi yang satu ini juga bisa dijalani dengan sistem
								kerja full time, part time, remote, hingga freelance.</p>

							<p align="justify">Prospek karier untuk profesi ini tentu sangat cerah, apalagi seorang
								Android developer terkadang tidak harus terikat satu perusahaan saja, sehingga
								kesempatan untuk mendapatkan penghasilan yang lebih banyak akan terbuka lebar. Seorang
								Android developer harus memiliki beberapa kemampuan agar siap bersaing di industri. Di
								Jobhun Academy, kamu bisa belajar menjadi seorang Android developer bersama dengan
								pakarnya langsung. Tidak hanya belajar secara teori saja, namun kamu juga akan praktek,
								sehingga bisa menghasilkan portfolio yang akan digunakan untuk mencari kerjaan nantinya.
							...
							<ul>
								...
								<li>Dasar-dasar pemrograman Java, variabel, tipe data, if else, switch case, for loop
								</li>
