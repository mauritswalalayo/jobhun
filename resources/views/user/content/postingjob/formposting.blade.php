								 ...
								 <form action="{{route('post.jobs')}}" method="POST" enctype="multipart/form-data">
					 				...
					 				<div class="row">
                                        ...
                                        <div class="col-lg-12">
					 						...
					 						<div class="pf-field">
					 							<input type="text" name="office_address" placeholder="Geco Coworking Space, Kompleks AJBS, Jl. Ratna 14, Ngagel, Wonokromo, Surabaya, Jawa Timur, Indonesia 60246" />
					 						</div>
                                         </div>
                                         ...
                                         <div class="col-lg-12">
					 						...
					 						<div class="pf-field">
					 							<input type="text" name="office_website" placeholder="www.jobhun.id" />
					 						</div>
                                         </div>
                                        ...
                                        <div class="col-lg-12">
					 						...
					 						<div class="pf-field">
					 							<input type="text" name="office_phone" placeholder="08113235533" />
					 						</div>
                                        </div>
